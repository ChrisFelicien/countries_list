...
const Navigation = ({ setCountry, setIsLoading }) => {
  ...
  return (
    <nav className='flex justify-around gap-8 p-8'>
      <input
        ...
        className='md:w-1/3 pl-4 py-1 text-lg rounded-md bg-slate-200 text-slate-900 translate-x-1 focus:outline-none w-full'
        value={countryName}
